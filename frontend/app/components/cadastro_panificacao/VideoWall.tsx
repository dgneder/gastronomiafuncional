...
const DEFAULT_VIDEOS: VideoItem[] = [
  {
    mp4: "/panificacao/videos/video_01.mp4",
    webm: "/panificacao/videos/video_01.webm",
    poster: "/panificacao/gallery/frigideira.jpg",
    title: "Pão de Frigideira",
    subtitle: "10 minutos · do zero ao pão",
  },
  {
    mp4: "/panificacao/videos/video_03.mp4",
  ...
  {
    mp4: "/panificacao/videos/video_05.mp4",
  ...
  {
    mp4: "/panificacao/videos/video_06.mp4",
  ...
  {
    mp4: "/panificacao/videos/video_07.mp4",
  ...
  {
    mp4: "/panificacao/videos/video_08.mp4",
...
function VideoCard({ v }: { v: VideoItem }) {
  ...
  return (
    <div ref={ref} className="rounded-xl overflow-hidden shadow-xl border border-stone-700/40 bg-stone-900">
