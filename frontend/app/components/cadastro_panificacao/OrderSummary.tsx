...
const items = [
  { name: "Pão Sem Culpa — 27 receitas + 12 caps de ciência", value: "R$97" },
    ...
    <div className="rounded-xl border border-stone-700/50 overflow-hidden">
      ...
      <div className="px-5 py-4 bg-stone-800/50 border-t border-stone-700/50">
        <div className="flex items-center justify-between mb-1">
          ...
          <span className="text-stone-500 text-sm line-through">R$214</span>
        </div>
        <div className="flex items-center justify-between mb-1">
          <span className="text-stone-400 text-sm">Preço regular</span>
          <span className="text-stone-400 text-sm line-through">R$47</span>
        </div>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="text-white font-bold text-lg">Hoje com cupom</span>
            <span className="px-2 py-0.5 bg-green-900/50 border border-green-700/50 rounded text-green-400 text-xs font-bold">
              -R$10
            </span>
          </div>
          <span className="text-amber-400 font-extrabold text-2xl">R$37</span>
        </div>
        <p className="text-stone-500 text-xs mt-2 text-right">
