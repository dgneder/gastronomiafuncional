  ...
  return (
    <div className="grid grid-cols-3 gap-2">
      {[
        ...
        <div key={i} className="text-center py-3 px-2 rounded-lg bg-stone-800/30 border border-stone-700/30">
          <item.icon className="text-amber-600/70 text-base mx-auto mb-1.5" />
