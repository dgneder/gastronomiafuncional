    ...
    <form ref={formRef} method="post" onSubmit={handleSubmit} className="space-y-3 lg:space-y-4">
      <div className="space-y-1">
        ...
        <input type="text" id="name" name="name" placeholder="Seu nome" required
          className="w-full px-4 py-3 bg-stone-800 border border-stone-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 text-white placeholder-stone-500 transition-all text-sm" />
      </div>
      ...
      <div className="space-y-1">
        ...
        <div className="flex">
          ...
          <input type="tel" id="phone" name="phone" placeholder="(00) 00000-0000" required
            ...
            className="w-full px-4 py-3 bg-stone-800 border border-stone-600 rounded-r-xl focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 text-white placeholder-stone-500 transition-all text-sm" />
        </div>
      ...
      <button type="submit" disabled={isSubmitting}
        ...
        style={{ background: isSubmitting ? "#6B3A2A" : "linear-gradient(135deg, #6B3A2A, #8B5A3C)" }}
      >
        {isSubmitting ? (
