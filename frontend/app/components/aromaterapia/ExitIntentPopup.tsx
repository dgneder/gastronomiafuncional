    ...
    >
      <div className="bg-white rounded-3xl p-8 max-w-md w-full text-center relative shadow-2xl">
        ...
        <p className="text-gray-600 text-sm mb-6 leading-relaxed">
          Por apenas <strong className="text-[#2D5016]">R$37</strong> você
          protege sua família e aprende a usar óleos essenciais com ciência de
          verdade. Garantia de 7 dias — risco zero.
        </p>
        ...
        <button
          ...
          className="w-full py-4 px-6 bg-gradient-to-r from-[#4A7C29] to-[#2D5016] hover:brightness-110 text-white font-black text-lg rounded-xl shadow-lg flex items-center justify-center gap-2 group transition-all"
        >
          <span>QUERO MEU GUIA — R$37</span>
