          ...
          <div className="flex flex-col md:flex-row items-center gap-10 relative z-10">
            ...
            <div className="text-center md:text-left">
              <h2 className="text-2xl md:text-3xl font-black text-gray-900 mb-4">
                Sua satisfação{" "}
                <span className="text-[#4A7C29]">blindada</span>
              </h2>

              <p className="text-gray-600 leading-relaxed mb-6">
                Eu quero que você tenha total tranquilidade. Se ao abrir o guia
                você sentir que o conteúdo não é o que esperava, ou se
                simplesmente mudar de ideia, você tem{" "}
                <strong>7 dias de garantia incondicional</strong>. Sem letras
                miúdas, sem formulários, sem constrangimento.
              </p>
              ...
              <p className="mt-8 text-sm text-gray-500 italic">
                &quot;O risco é todo meu. O conhecimento é todo seu.&quot; — Dr.
                Diogo Gonçalves
              </p>
            </div>
          </div>
