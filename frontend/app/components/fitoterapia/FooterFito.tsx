  ...
  return (
    <footer className="bg-gray-900 text-gray-400 py-12 px-4 border-t border-gray-800">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed">
              Cientista, Engenheiro Agrônomo e Doutor em Genética de Plantas. Dedicado a traduzir a complexidade da botânica em saúde prática e segura.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-3">
              <a href="mailto:suporte@seudominio.com" className="hover:text-white transition-colors flex items-center gap-2 text-sm">
                <FaEnvelope className="text-[#4A7C29]" /> suporte@vivendodeplantas.com
              </a>
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm">
              Sua compra é processada de forma 100% segura. O acesso ao material é enviado imediatamente após a confirmação.
            </p>
        ...
        {/* Termos e Disclaimers (CRUCIAL PARA ADS) */}
        <div className="pt-8 border-t border-gray-800 text-[10px] sm:text-xs space-y-4 text-justify leading-relaxed">
          <p>
            <strong>AVISO LEGAL:</strong> As informações contidas neste e-book e nesta página não substituem a consulta médica profissional. O Dr. Diogo Gonçalves é Doutor em Genética de Plantas e Agrônomo, e as orientações aqui descritas são baseadas em literatura científica e botânica. Sempre consulte seu médico antes de iniciar qualquer tratamento com plantas medicinais, especialmente se você já utiliza medicamentos de uso contínuo, está grávida ou amamentando.
          </p>
          <p>
          ...
          <div className="flex flex-wrap justify-between items-center pt-4">
            <p>© {currentYear} Vivendo de Plantas - Todos os direitos reservados.</p>
            <div className="flex gap-4">
              <a href="#" className="underline hover:text-white">Políticas de Privacidade</a>
