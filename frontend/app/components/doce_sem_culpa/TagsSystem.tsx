...
const dietaryTags = [
  ...
  { emoji: "🟠", code: "KETO",  label: "Keto (<5g net carbs)",      color: "#F97316" },
];
...
const healthTags = [
  ...
  { emoji: "🌿", code: "ANTI-INF",  label: "Anti-inflamatório",          color: "#5B8B7D" },
  { emoji: "🛡️", code: "IMUNE",     label: "Imunidade",                  color: "#6366F1" },
  { emoji: "🔥", code: "ENERGY",    label: "Energia & Pré-Treino",       color: "#DC2626" },
  { emoji: "🍃", code: "DIGEST",    label: "Saúde Digestiva",            color: "#16A34A" },
  { emoji: "💪", code: "PROTEICO",  label: "Proteína (+15g)",            color: "#7C3AED" },
  { emoji: "👶", code: "KIDS",      label: "Aprovado por Crianças",      color: "#EC4899" },
  { emoji: "💰", code: "PV",        label: "Pra Vender (margem alta)",   color: "#B45309" },
];
      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-14">
          <p className="text-sm uppercase tracking-widest font-semibold mb-3" style={{ color: "#8B2252" }}>
            Sistema de Tags Duplas
          </p>
          <h2 className="text-3xl lg:text-4xl font-extrabold text-stone-800">
            Encontre <span style={{ color: "#8B2252" }}>a receita certa</span> em segundos
          </h2>
          <p className="mt-4 text-lg text-stone-500 max-w-2xl mx-auto">
            Cada uma das 252 receitas é classificada com tags duplas: <strong>restrição alimentar</strong> + <strong>condição de saúde</strong>.
            Funciona como um GPS para a sua necessidade específica.
          </p>
        </div>
        ...
        {/* Exemplo */}
        <div
          className="mt-10 bg-white rounded-2xl p-8 shadow-sm border text-center"
