    ...
    >
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-lg text-stone-600 leading-relaxed mb-6 max-w-2xl mx-auto">
          Abra os ebooks, acesse a plataforma, escolha uma receita e coloque a mão na massa.
          Se em até 7 dias você não estiver satisfeito com o que aprendeu, basta solicitar reembolso
          total pela Hotmart. Um clique, sem perguntas, sem burocracia.
        </p>
        ...
        <p className="font-semibold text-sm mt-6" style={{ color: "#8B2252" }}>
