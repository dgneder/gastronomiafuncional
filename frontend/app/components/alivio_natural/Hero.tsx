...
import { FaCheckCircle, FaShieldAlt, FaArrowRight, FaFlask } from "react-icons/fa";
...
const Hero: React.FC<HeroProps> = ({ onButtonClick }) => {
  return (
    <section id="hero" className="relative bg-linear-to-b from-[#1E2A10] via-[#2D3B1A] to-[#3A5020] overflow-hidden pt-14">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:gap-12">
            <div className="lg:w-[58%] text-center lg:text-left">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-[2.6rem] xl:text-5xl font-extrabold text-white leading-[1.12] mb-5">
                As <span className="text-[#D4A520] italic font-bold">15 Plantas Medicinais</span> que a ciência comprovou para o manejo natural de <span className="text-[#A3D977]">dores e inflamação</span>
              </h1>

              <p className="text-base sm:text-lg text-white/80 mb-6 max-w-xl mx-auto lg:mx-0 leading-relaxed">
                Dosagens exatas, protocolos prontos e preparações seguras — organizados por um pesquisador com doutorado em genética vegetal e 20 anos de experiência acadêmica.
              </p>
              ...
              <div className="bg-white/10 backdrop-blur-sm border border-white/15 rounded-2xl p-5 max-w-md mx-auto lg:mx-0">
                <div className="flex items-baseline gap-2 justify-center lg:justify-start mb-4">
                  ...
                  <span className="text-4xl font-black text-[#D4A520]">R$47</span>
                  <span className="text-white/60 text-sm ml-1">pagamento único</span>
                </div>

                <button onClick={onButtonClick} className="w-full py-4 px-6 bg-linear-to-r from-[#D97706] to-[#B45309] hover:brightness-110 text-white font-black text-lg rounded-xl shadow-[0_8px_24px_rgba(217,119,6,0.4)] transform hover:scale-[1.02] transition-all duration-200 flex flex-col items-center">
            ...
            <div className="lg:w-[42%] mt-10 lg:mt-0">
              <div className="relative max-w-sm mx-auto">
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.5)] border border-white/10" style={{ paddingBottom: "0" }}>
                  <div className="relative w-full overflow-hidden rounded-2xl" style={{ height: "420px" }}>
                    <Image src="/alivio_natural/mockup.png" alt="E-book Alívio Natural" fill className="object-cover object-top" priority />
                  </div>
                </div>
                <div className="absolute -bottom-4 -right-4 bg-[#D97706] text-white rounded-2xl shadow-xl p-3 text-center">
                  ...
                  <p className="text-[9px] uppercase font-bold tracking-tighter opacity-90">Páginas</p>
                </div>
                <div className="absolute -top-4 -left-4 bg-white rounded-2xl shadow-xl p-3 text-center">
                  ...
                  <p className="text-[9px] uppercase font-bold tracking-tighter text-gray-500">Plantas</p>
                </div>
              </div>
            </div>
          </div>
