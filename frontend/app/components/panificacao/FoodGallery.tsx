...
const DEFAULT_VIDEOS: VideoItem[] = [
  {
    webm: "/panificacao/videos/video_03.webm",
    poster: "/panificacao/gallery/frigideira.jpg",
    title: "Pão de Frigideira",
    subtitle: "10 minutos · SG · DIA",
  },
  {
    webm: "/panificacao/videos/video_04.webm",
    poster: "/panificacao/gallery/pao_queijo.jpg",
    title: "Pão de Queijo Funcional",
    subtitle: "SG · DIA · RENAL",
  },
  {
    webm: "/panificacao/videos/video_05.webm",
    poster: "/panificacao/gallery/focaccia.jpg",
    title: "Focaccia",
    subtitle: "Alta hidratação · ANTI-INF",
  },
  {
    webm: "/panificacao/videos/video_06.webm",
    poster: "/panificacao/gallery/hamburguer.jpg",
    title: "Hambúrguer Funcional",
    subtitle: "IG 42 · SG",
  },
  {
    webm: "/panificacao/videos/video_07.webm",
    poster: "/panificacao/gallery/sourdough.jpg",
    title: "Sourdough 48h",
    subtitle: "Fermentação Natural · LC",
  },
  {
    webm: "/panificacao/videos/video_08.webm",
    poster: "/panificacao/gallery/tortilha.jpg",
    title: "Tortilha Funcional",
    subtitle: "10 min · VEG · SG",
  },
  {
    webm: "/panificacao/videos/video_09.webm",
    poster: "/panificacao/gallery/caneca.jpg",
    title: "Pão de Caneca",
    subtitle: "5 min · SG · DIA",
  },
];
...
function VideoCard({ v }: { v: VideoItem }) {
  ...
  const mp4Src = v.webm.replace(/\.webm$/, ".mp4");

  return (
    <div
      ref={wrapRef}
      className="rounded-2xl overflow-hidden bg-white shadow-md border border-stone-100 hover:shadow-xl transition-shadow duration-300"
    >
      <div className="relative">
        ...
        {/* CORRIGIDO: bg-linear-to-t → bg-gradient-to-t */}
        <div className="absolute inset-0 bg-linear-to-t from-stone-900/60 via-transparent to-transparent" />

        {(v.title || v.subtitle) && (
          <div className="absolute bottom-3 left-3 right-3">
            {v.title && (
              <p className="text-white text-sm font-bold drop-shadow-md">{v.title}</p>
            )}
            {v.subtitle && (
              <p className="text-amber-300 text-xs font-medium mt-0.5">{v.subtitle}</p>
            )}
          </div>
        )}
      </div>
