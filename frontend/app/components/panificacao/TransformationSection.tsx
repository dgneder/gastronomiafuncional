...
const after = [
  ...
  "27 receitas testadas com ciência por trás",
  ...
  return (
    <section className="py-20 px-6 lg:px-12 bg-white" data-aos="fade-up">
      <div className="max-w-5xl mx-auto">
        ...
        {/* IMAGEM DE SUBSTITUIÇÃO DO VÍDEO (Prova Visual de Textura) */}
        <div className="max-w-4xl mx-auto mb-12" data-aos="zoom-in">
          <div className="relative w-full aspect-video md:aspect-21/9 rounded-2xl overflow-hidden shadow-2xl border-4 border-white">
            <Image
              src="/panificacao/resultado_real.jpeg" // Sugestão: Use a foto da Receita 03 (Pão de queijo funcional) ou do miolo do Sourdough
              alt="Interior macio e perfeito do pão funcional"
              fill
              className="object-cover"
            />
            {/* Overlay elegante para reforçar a promessa */}
