...
import { FaGraduationCap, FaMicroscope, FaHeartbeat, FaUniversity } from "react-icons/fa";

const credentials = [
  { icon: FaGraduationCap, text: "Doutor em Genética e Melhoramento de Plantas" },
  { icon: FaMicroscope, text: "Pesquisador em leveduras e fermentação" },
  { icon: FaUniversity, text: "Professor Universitário (UEPB)" },
      ...
      <div className="max-w-6xl mx-auto lg:flex lg:items-center lg:gap-16">
        ...
        <div className="lg:w-7/12 space-y-6" data-aos="fade-left">
          ...
          <h2 className="text-3xl lg:text-4xl font-extrabold text-stone-800 leading-tight">
            Um cientista que pesquisa leveduras —<br />
            <span style={{ color: "#6B3A2A" }}>e que precisa cuidar da própria saúde</span>
          </h2>

          <p className="text-stone-600 text-lg leading-relaxed">
            Como Engenheiro Agrônomo e Doutor em Genética, passei anos estudando ao microscópio
            os microrganismos que fazem o pão existir. Mas foi convivendo com doença renal,
            diabetes e hipertensão que entendi: a panificação funcional não é modismo
            — é necessidade.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-4">
            {credentials.map((cred, i) => (
              <div key={i} className="flex items-center gap-3 bg-white/70 backdrop-blur-sm rounded-lg px-4 py-3 shadow-sm">
