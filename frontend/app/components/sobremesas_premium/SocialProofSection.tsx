...
// Adicionamos a interface para aceitar a função
interface SocialProofProps {
  onButtonClick: () => void;
}

const SocialProofSection: React.FC<SocialProofProps> = ({ onButtonClick }) => {
  return (
    <section
      id="social-proof"
      data-aos="fade-up"
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        {/* CTA com emoção - Agora usa a função recebida */}
        <div className="mt-16">
