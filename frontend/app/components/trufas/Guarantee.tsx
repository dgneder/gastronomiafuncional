  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto">
        {/* Ícone de Garantia */}
        <FaShieldAlt className="text-amber-600 text-6xl mx-auto mb-6" />
        ...
        <p className="text-gray-700 text-lg mb-8 leading-relaxed">
          ...
          <span className="font-semibold text-amber-600">Guia de Trufas e Docinhos Funcionais</span>.
        ...
        <p className="text-gray-500 text-base">
          ...
          <span className="font-semibold text-amber-600">Hotmart</span>, uma das maiores plataformas de produtos digitais do Brasil. Você terá acesso imediato ao conteúdo e poderá solicitar seu reembolso com apenas alguns cliques, se necessário.
        </p>

        {/* Nota de Isenção de Riscos */}
        <p className="text-amber-700 font-medium mt-6 text-sm">
